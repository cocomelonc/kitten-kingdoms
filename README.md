...
- Zero runtime dependencies, matching the rest of the series: the kingdom
  ...
  `java.io` streams, not a database library.
...
открывая землю по пути, а на открытых клетках можно строить: добывать пять
видов ресурсов, возводить десять типов зданий и исследовать дерево из девяти
технологий. Здесь нет рекламы, регистрации, покупок, аналитики, сети,
таймеров, жизней и экрана проигрыша - королевство может только расти.
