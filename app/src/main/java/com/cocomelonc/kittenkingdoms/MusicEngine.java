...
final class MusicEngine {
    ...
    private final ExecutorService musicExecutor = Executors.newSingleThreadExecutor(runnable -> {
        Thread thread = new Thread(runnable, "kitten-kingdoms-music");
    ...
    /** Renders a quiet 12-second four-chord pond loop with a soft pentatonic melody. */
